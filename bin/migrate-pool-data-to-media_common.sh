...
FASTRESUME_DIR="${FASTRESUME_DIR:-/dump/docker/gluetun_qbit/qbittorrent_vpn/qBittorrent/BT_backup}"  # host-specific; override via FASTRESUME_DIR env var
...
RECHECK_TIMEOUT="${RECHECK_TIMEOUT:-1800}"
BATCH_SIZE="${BATCH_SIZE:-0}"
PILOT_SIZE="${PILOT_SIZE:-5}"
PILOT_OBSERVE_SECONDS="${PILOT_OBSERVE_SECONDS:-60}"
...
RECHECK_SOURCE_ON_VERIFY_FAIL="${RECHECK_SOURCE_ON_VERIFY_FAIL:-1}"
PREVERIFY_SOURCE="${PREVERIFY_SOURCE:-0}"
