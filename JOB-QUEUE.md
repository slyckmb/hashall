...
| j51 | qb-stoppeddl-recovery | OP-62,OP-70,OP-78,OP-79,OP-80,OP-81,OP-82,OP-83,OP-84,OP-85 | Active recovery in progress. t10+t11 live verified-retarget batches succeeded, later t12 work brought live qB to `stoppedDL=362`, `stoppedUP=4554`; approved t13-t20 live verified-retarget succeeded and moved qB to `stoppedDL=170`, `stoppedUP=4746`; approved 157-hash follow-up brought qB to 7 active stoppedDL hard-tail rows. Current tail: Yu-Gi-Oh `399f4c0bbb79` and Supernatural `09c5e08c31eb` now have full class-A piece proof and apply dry-runs ready for explicit live fastresume-retarget approval; Nintendo `09bceba1b43c` is RT `stalledUP` on pool but still lacks complete independent byte proof; River Monsters, Dexter S02, Transformers, and Dexter S07 are proven partial/no-seed or Plan B rows and must not be forced to `stoppedUP`. Dexter S02 old source cleanup has a guarded dry-run ready but still requires exact delete approval. Next: apply the Yu-Gi-Oh retarget only after approval, reclaim Dexter S02 old source only after approval, and handle the remaining partial/no-seed rows through the documented variant/replacement process. |
