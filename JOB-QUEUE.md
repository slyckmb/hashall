...
| j51 | qb-stoppeddl-recovery | OP-62,OP-70,OP-78,OP-79 | Active recovery ready for approval-gated verified-retarget pilots. OP-79 v0.2.14 adds explicit verified fastresume retarget mode. Three batches are prepared: 24 verified from t10, 22 verified from t11, and 24 approval-ready from t12; all 70 are still live `stoppedDL`. |
