...
| j51 | qb-stoppeddl-recovery | OP-62,OP-70,OP-78,OP-79,OP-80 | Active recovery in progress. t10+t11 live verified-retarget batches succeeded, later t12 work brought live qB to `stoppedDL=362`, `stoppedUP=4554`. Current near-complete class: 9 qB `stoppedDL` rows at `99.*%`, all now classified as `tracker-healthy-waiting` rather than automatic replacement-needed. Next approval-ready broad drain batches: filtered t13=24, t14=18, t15=25, t16=25, t17=25, t18=25, t19=25, and t20=25. |
...
- j51 (qb-stoppeddl-recovery, OP-62/OP-70/OP-78/OP-79/OP-80) active recovery in progress — OP-62 started as 440 missingFiles. Current 2026-07-09 refresh: qB `stoppedDL=362`, `stoppedUP=4554`, active upload/download=0; bucket `/tmp/qb-stoppeddl-bucket-live` has 441 original hashes. DB refresh artifacts live under `.agent/reports/db-refresh-j51-20260707-045304/`. Correction after t07: generic catalog-drain policy was the wrong first lens; direct RT session mapping shows all 441 qB stoppedDL hashes are present in rTorrent and all 441 RT paths exist. Original t09 path-shape Class A evidence was not apply-compatible, so the first approved 25-hash batch was re-verified: 24 verified, 1 failed partial-match hash (`376c463cd58324`). OP-79 v0.2.14 added explicit `--allow-verified-fastresume-cross-filesystem`, limited to independently verified fastresume-only retargets. Approved t10 and t11 live batches succeeded; t12 progress is reflected in the current live count. OP-80 corrects the near-99 policy: 9 current qB `99.* stoppedDL` rows have piece deficits but usable trackers and successful RT announce counters, so they are `tracker-healthy-waiting`, not completed repairs and not automatic replacement-needed. Next approval-ready broad drain batches: filtered t13 has 24 current `stoppedDL` hashes verified and dry-run clean (`same_filesystem_overridden=24`, blocked=0) in `/tmp/qb-stoppeddl-bucket-live/reports/j51-t13-verified-24-current-stoppeddl-apply-dryrun.json`; t14 has 18 verified hashes dry-run clean (`same_filesystem_overridden=18`, blocked=0) in `/tmp/qb-stoppeddl-bucket-live/reports/j51-t14-verified-18-apply-dryrun.json`; t15 has 25 verified hashes dry-run clean (`same_filesystem_overridden=25`, blocked=0) in `/tmp/qb-stoppeddl-bucket-live/reports/j51-t15-verified-25-apply-dryrun.json`; t16 has 25 verified hashes dry-run clean (`same_filesystem_overridden=25`, blocked=0) in `/tmp/qb-stoppeddl-bucket-live/reports/j51-t16-verified-25-apply-dryrun.json`; t17 has 25 verified hashes dry-run clean (`same_filesystem_overridden=25`, blocked=0) in `/tmp/qb-stoppeddl-bucket-live/reports/j51-t17-verified-25-apply-dryrun.json`; t18 has 25 verified hashes dry-run clean (`same_filesystem_overridden=25`, blocked=0) in `/tmp/qb-stoppeddl-bucket-live/reports/j51-t18-verified-25-apply-dryrun.json`; t19 has 25 verified hashes dry-run clean (`same_filesystem_overridden=25`, blocked=0) in `/tmp/qb-stoppeddl-bucket-live/reports/j51-t19-verified-25-apply-dryrun.json`; t20 has 25 verified hashes dry-run clean (`same_filesystem_overridden=25`, blocked=0) in `/tmp/qb-stoppeddl-bucket-live/reports/j51-t20-verified-25-apply-dryrun.json`. Seven t14 candidates are excluded for now: 6 missing verifier reports/no-candidate rows and 1 huge Nintendo set timed out at 19.6% after 900s. Next: continue j51 with approved verified-fastresume batches while keeping the 9 tracker-healthy waits in an explicit monitor bucket.
