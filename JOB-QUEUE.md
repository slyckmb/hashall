...
| j51 | qb-stoppeddl-recovery | OP-62,OP-70,OP-78,OP-79,OP-80 | Active recovery in progress. t10+t11 live verified-retarget batches succeeded, later t12 work brought live qB to `stoppedDL=362`, `stoppedUP=4554`; approved t13-t20 live verified-retarget succeeded and moved qB to `stoppedDL=170`, `stoppedUP=4746`. Current near-complete class: 9 qB `stoppedDL` rows at `99.*%`, all classified as `tracker-healthy-waiting` rather than automatic replacement-needed. Next: continue read-only verification expansion from t21 for remaining stoppedDL rows. |
