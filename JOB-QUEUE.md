...
| j51 | qb-stoppeddl-recovery | OP-62,OP-70,OP-78,OP-79 | Active recovery ready for approval-gated verified-retarget pilots. OP-79 v0.2.14 adds explicit verified fastresume retarget mode. Two batches are prepared: 24 verified from t10 and 22 verified from t11; both dry-run with `same_filesystem_overridden` and all 46 are still live `stoppedDL`. |
