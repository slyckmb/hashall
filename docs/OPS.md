...
| ~~OP-39~~ | ~~reliability~~ | ~~Novitiate repointed to darkpeers/ (mkdir subfolder + hardlink + repoint); M3GAN repointed to stash/movies/; West.Wing.S02 repointed to hawke-uno/; all state=1 complete=1~~ | ~~closed:j34~~ |
| ~~OP-40~~ | ~~reliability~~ | ~~English.Teacher.S01 located at stash/PrivateHD/ (nlinks=19); repointed; state=1 complete=1. Beetlejuice+UEFA remain OP-24 (excluded, human inspection required)~~ | ~~closed:j34~~ |
